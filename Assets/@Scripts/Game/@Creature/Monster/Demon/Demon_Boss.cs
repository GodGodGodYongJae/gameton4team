...
public class Demon_Boss : SPUM_Monster
{
    ...
    {
        string attackString = "5_Attack_Normal";
        ...
        GameObject bulletGo = await Managers.Object.InstantiateAsync(arrow.name, new Vector2(transform.position.x  + (0.5f * -Bulletdirection), transform.position.y + 0.5f));
