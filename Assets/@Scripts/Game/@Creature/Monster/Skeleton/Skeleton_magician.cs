...
public class Skeleton_magician : SPUM_Monster
{
    ...
    async UniTaskVoid AttackAsync()
    {
        ...
        GameObject bulletGo = Managers.Object.InstantiateAsync(arrow.name, new Vector2(transform.position.x  +(2* -Bulletdirection), transform.position.y + 0.5f));
