...
public class Skeleton_Boss : SPUM_Monster
{
    ...
    async UniTaskVoid AttackAsync()
    {
        ...
        GameObject bulletGo = await Managers.Object.InstantiateAsync(arrow.name, new Vector2(transform.position.x + (3 * direction), transform.position.y + 0.5f));
