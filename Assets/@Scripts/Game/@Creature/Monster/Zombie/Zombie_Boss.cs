...
public class Zombie_Boss : SPUM_Monster
{
    ...
    async UniTaskVoid AttackAsync()
    {
        ...
        GameObject bulletGo = Managers.Object.InstantiateAsync(arrow.name, new Vector2(transform.position.x +(1* -Bulletdirection), transform.position.y + 0.5f));
