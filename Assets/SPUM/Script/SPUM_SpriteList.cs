...
public class SPUM_SpriteList : MonoBehaviour
{
    ...
    private List<List<SpriteRenderer>> _allSpriteList = new List<List<SpriteRenderer>>();
    public List<List<SpriteRenderer>> AllSpriteList => _allSpriteList;
    ...
    {
        _allSpriteList.Clear();
        _allSpriteList.Add(_itemList);
        _allSpriteList.Add(_eyeList);
        _allSpriteList.Add(_hairList);
        _allSpriteList.Add(_bodyList);
        _allSpriteList.Add(_clothList);
        _allSpriteList.Add(_armorList);
        _allSpriteList.Add(_pantList);
        _allSpriteList.Add(_weaponList);
        _allSpriteList.Add(_backList);
    }
